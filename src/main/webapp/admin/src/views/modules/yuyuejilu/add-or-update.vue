<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.wenjianziliao" label="文件资料" prop="wenjianziliao">
          <file-upload
          tip="点击上传文件资料"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.wenjianziliao" label="文件资料" prop="wenjianziliao">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.wenjianziliao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="实验记录" prop="shiyanjilu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="实验记录"
                  v-model="ruleForm.shiyanjilu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shiyanjilu" label="实验记录" prop="shiyanjilu">
                    <span>{{ruleForm.shiyanjilu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kechengmingcheng = true;
          ...
          if(o=='shiyanjilu'){
            this.ruleForm.shiyanjilu = obj[o];
	    this.ro.shiyanjilu = true;
            continue;
          }
          if(o=='wenjianziliao'){
	...
	if(this.ruleForm.wenjianziliao!=null) {
		this.ruleForm.wenjianziliao = this.ruleForm.wenjianziliao.replace(new RegExp(this.$base.url,"g"),"");
	}
