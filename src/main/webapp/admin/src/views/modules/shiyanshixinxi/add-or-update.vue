        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shiyongshuoming" label="使用说明" prop="shiyongshuoming">
                    <span>{{ruleForm.shiyongshuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
       ...
       this.ruleForm.shiyanshizhuangtai='可安排'
      }
      // 获取用户信息
      this.$http({
