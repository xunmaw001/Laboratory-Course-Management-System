    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="归还备注" prop="guihaibeizhu">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.guihaibeizhu" label="归还备注" prop="guihaibeizhu">
                    <span>{{ruleForm.guihaibeizhu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.shebeishuliang = parseFloat(objcross.shebeishuliang) + parseFloat(this.ruleForm.shebeishuliang)
                }
