<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.shiyanziliao" label="实验资料" prop="shiyanziliao">
          <file-upload
          tip="点击上传实验资料"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.shiyanziliao?ruleForm.shiyanziliao:''"
          @change="shiyanziliaoUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.shiyanziliao" label="实验资料" prop="shiyanziliao">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.shiyanziliao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shiyanshitupian" label="实验室图片" prop="shiyanshitupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shiyanshitupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="项目编排" prop="xiangmubianpai">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="项目编排"
                  v-model="ruleForm.xiangmubianpai" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiangmubianpai" label="项目编排" prop="xiangmubianpai">
                    <span>{{ruleForm.xiangmubianpai}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kechengmingcheng = true;
          ...
          if(o=='xiangmubianpai'){
            this.ruleForm.xiangmubianpai = obj[o];
	    this.ro.xiangmubianpai = true;
            continue;
          }
          if(o=='shiyanziliao'){
            this.ruleForm.shiyanziliao = obj[o];
	    this.ro.shiyanziliao = true;
            continue;
          }
          if(o=='kechengshijian'){
	...
	if(this.ruleForm.shiyanziliao!=null) {
		this.ruleForm.shiyanziliao = this.ruleForm.shiyanziliao.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    shiyanziliaoUploadChange(fileUrls) {
	this.ruleForm.shiyanziliao = fileUrls;
	this.addEditUploadStyleChange()
    },
