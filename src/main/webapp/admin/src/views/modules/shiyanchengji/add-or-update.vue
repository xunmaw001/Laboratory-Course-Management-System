<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="违规情况" prop="weiguiqingkuang">
          <el-select :disabled="ro.weiguiqingkuang" v-model="ruleForm.weiguiqingkuang" placeholder="请选择违规情况">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="违规情况" prop="weiguiqingkuang">
	      <el-input v-model="ruleForm.weiguiqingkuang"
                placeholder="违规情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实验成绩" prop="shiyanchengji">
          <el-input v-model="ruleForm.shiyanchengji" 
              placeholder="实验成绩" clearable  :readonly="ro.shiyanchengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实验成绩" prop="shiyanchengji">
              <el-input v-model="ruleForm.shiyanchengji" 
                placeholder="实验成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	crossrefid : false,
      ...
      rules: {
          ...
          shiyanchengji: [
                { required: true, message: '实验成绩不能为空', trigger: 'blur' },
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kechengmingcheng = true;
          ...
          if(o=='weiguiqingkuang'){
            this.ruleForm.weiguiqingkuang = obj[o];
	    this.ro.weiguiqingkuang = true;
            continue;
          }
          if(o=='shiyanchengji'){
            this.ruleForm.shiyanchengji = obj[o];
	    this.ro.shiyanchengji = true;
            continue;
          }
          if(o=='chengjipingyu'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shiyanchengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shiyanchengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
