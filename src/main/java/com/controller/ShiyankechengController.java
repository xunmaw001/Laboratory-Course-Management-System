...
public class ShiyankechengController {
    ...
    public R page(@RequestParam Map<String, Object> params,ShiyankechengEntity shiyankecheng, 
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date kechengshijianstart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date kechengshijianend,
        ...
        EntityWrapper<ShiyankechengEntity> ew = new EntityWrapper<ShiyankechengEntity>();
                if(kechengshijianstart!=null) ew.ge("kechengshijian", kechengshijianstart);
                if(kechengshijianend!=null) ew.le("kechengshijian", kechengshijianend);
